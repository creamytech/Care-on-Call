...
export const metadata: Metadata = {
  ...
  description: 'Contact Care on Call Home Healthcare in Fort Lauderdale, FL. Call (954) 358-5001 for quality home healthcare services. Located at 211 E Prospect Rd. (NE 44th St.)',
