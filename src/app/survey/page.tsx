            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Star className="h-5 w-5 text-gray-700 mt-0.5 mr-3 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="space-y-1 text-sm">
                  <p><a href="tel:954-358-5001" className="text-gray-700 hover:underline">(954) 358-5001</a></p>
                  <p><a href="tel:877-255-9090" className="text-gray-700 hover:underline">1-877-255-9090</a></p>
                </div>
              </div>
