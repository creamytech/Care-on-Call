            ...
            <div className="bg-brand/5 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-white rounded-lg">
                  <Award className="h-8 w-8 text-brand mr-4" />
                  <div>
                    <div className="font-semibold text-brand">State of Florida Licensed</div>
                    <div className="text-sm text-gray-600">License # 299993274</div>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white rounded-lg">
                  <Users className="h-8 w-8 text-brand mr-4" />
                  <div>
                    <div className="font-semibold text-brand">Locally Owned & Operated</div>
                    <div className="text-sm text-gray-600">Fort Lauderdale, Florida</div>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white rounded-lg">
                  <Heart className="h-8 w-8 text-brand mr-4" />
                  <div>
                    <div className="font-semibold text-brand">Medicare Certified</div>
